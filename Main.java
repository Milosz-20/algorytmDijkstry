...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Wprowadź liczbę krawędzi:");
        int liczbaKrawedzi = scanner.nextInt();

        System.out.println("Wprowadż wierzchołki (w1 w2 waga)");
        ...
        System.out.println("Podaj wierzchołki pomiędzy którymi chcesz obliczyć najkrótszą ścieżkę (w1 w2):");
        char start = scanner.next().charAt(0);
        char koniec = scanner.next().charAt(0);

        Map<Character, Object> wynik = graf.dijkstra(start, koniec);
        System.out.println("Waga najkrótszej ścieżki między " + start + " a " + koniec + " wynosi: " + wynik.get(koniec));
        System.out.println("Długość najkrótszej ścieżki wynosi " + wynik.get('N'));
